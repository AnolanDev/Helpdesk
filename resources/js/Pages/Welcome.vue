...
<template>
    <Head title="HelpTech - Sistema de Soporte Técnico" />
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-20 items-center justify-between">
                    <div class="flex items-center gap-3">
                        <img src="/images/logo.svg" alt="Logo" class="h-16 w-16 rounded-xl object-cover shadow-sm" />
                        <span class="text-xl font-bold text-secondary-900">HelpTech</span>
                    </div>
            ...
            <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    ...
                    <p class="mt-4 text-lg text-primary-100">
                        Únete a HelpTech y lleva tu gestión al siguiente nivel
                    </p>
            ...
            <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
                <div class="text-center">
                    <div class="flex items-center justify-center gap-2">
                        ...
                        <span class="text-lg font-bold text-secondary-900">HelpTech</span>
                    </div>
